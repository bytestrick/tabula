...
export class HomeComponent implements AfterViewInit, OnInit {
  ...
  @ViewChild('formCreateTableCard') formCreateTableCard!: FormCreateTableCardComponent;
  @ViewChild('formEditTableCard') formEditTableCard!: FormEditTableCardComponent;
  ...
  addTableCard(tableCard: TableCard): void {
    let tableCardComponent: TableCardComponent = TableCardComponent.create(this.tableCardContainerView);
    tableCardComponent.init(tableCard);

    tableCardComponent.editTableCard.subscribe((tableCardComponent: TableCardComponent): void => {
      this.editTableCard(tableCardComponent);
    })
  }
